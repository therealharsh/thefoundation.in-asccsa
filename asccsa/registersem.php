...
$email = addslashes("$email1");
	...
	$con=mysql_connect("localhost","asccsa", "hak14295") or die(mysql_error());
	mysql_select_db("database1");
	$updateInfo = "INSERT INTO seminar(fullname, date, education, employment, areaofwork, organization, orgdesc, position, address, teleno, mobno, email) VALUES ('$fullName', CURDATE(), '$education', '$emptype', '$areaofwork', '$orgname', '$descorg', '$position', '$address', '$tphone', '$mphone', '$email');";
  	mysql_query($updateInfo, $con);


header( "refresh:4;url=index.php" );
  	echo"You have registered for the ASCCSA 2015. We will get in touch soon!";
